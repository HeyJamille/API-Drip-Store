...
// Rotas
CategoriasRotas.get('/categorias', categoriasController.listar);
CategoriasRotas.post('/categorias', categoriasController.criar);
CategoriasRotas.delete('/categorias/:id', categoriasController.deletar);
